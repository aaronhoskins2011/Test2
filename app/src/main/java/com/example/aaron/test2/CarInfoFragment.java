 ...
 * {@link CarInfoFragment.OnFragmentInteractionListener} interface
...
public class CarInfoFragment extends Fragment {
    ...
    public void onButtonPressed(Cars car) {
        if (mListener != null) {
            car = new Cars(etCarModel.getText().toString(),etCarType.getText().toString(),Integer.getInteger(etCarYear.getText().toString()));
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        etCarType = (EditText)view.findViewById(R.id.etCarType);
        etCarYear = (EditText)view.findViewById(R.id.etCarYear);
        btnSendToList = (Button) view.findViewById(R.id.btnSendInfo);
        btnSendToList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cars car;
                if (mListener != null) {
                    car = new Cars(etCarModel.getText().toString(),etCarType.getText().toString(),10);
                    mListener.onFragmentInteraction(car);
                }
            }
        });
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(Cars car);
