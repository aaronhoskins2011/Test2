...
public class CarListFragment extends Fragment  {
    ...
    public static CarListFragment newInstance(List<Cars> cars, String param2) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        carListAdaptor = new CarListAdaptor(carsList);
        rvCarList.setAdapter(carListAdaptor);
